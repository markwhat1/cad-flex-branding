...
o=o.then(n,t.always&&n)}),o.done(function(){i._trigger("processdone",null,r),i._trigger("processalways",null,r)}).fail(function(){i._trigger("processfail",null,r),i._trigger("processalways",null,r)}),o},_transformProcessQueue:function(r){var s=[]
...
t.index=o,s._processing+=1,s._processingQueue=s._processingQueue.then(n,n).always(function(){s._processing-=1,0===s._processing&&s._trigger("processstop")})})),this._processingQueue},_create:function(){this._super(),this._processing=0,this._processingQueue=e.Deferred().resolveWith(this).promise()}})})
